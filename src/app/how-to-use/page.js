    ...
    <div className="how-to-use-page">
      ...
      <section className="how-to-use-video-section">
        <div className="how-to-use-content">
          ...
          <p>
            Watch this quick tutorial to learn everything you need to know about creating and
            customizing your boards. From adding tiles to organizing your content, we'll guide you
            through all the essential features.
          </p>
          <p>
